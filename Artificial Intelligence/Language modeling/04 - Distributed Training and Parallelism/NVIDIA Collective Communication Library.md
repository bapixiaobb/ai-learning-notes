...
NCCL 是 NVIDIA 的 [GPU](<../../GPU%20and%20NPU/GPU.md>) communication library。
...
- 识别 [GPU Communication Topology](<../../GPU%20and%20NPU/GPU%20Communication%20Topology.md>)，比如哪些 GPU 在同一个 node、哪些路径走 NVLink / NVSwitch。
...
[backward pass](<../../Neural%20Networks/Backpropagation.md>) 后 gradients 不同，所以需要：
...
每个 rank 只算出 [activation](<../../Neural%20Networks/Activations.md>) 的一部分。
...
[GPU Communication Topology](<../../GPU%20and%20NPU/GPU%20Communication%20Topology.md>)
