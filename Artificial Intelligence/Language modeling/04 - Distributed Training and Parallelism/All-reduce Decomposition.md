...
![all-reduce = reduce-scatter + all-gather.png](<../../attachments/all-reduce%20=%20reduce-scatter%20+%20all-gather.png>) [All-Reduce](<All-Reduce.md>) = [Reduce-Scatter](<Reduce-Scatter.md>) + [All-Gather](<All-Gather.md>)
