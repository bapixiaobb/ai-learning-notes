...
但当一次 training step 所需的 compute 或 memory 超过单张 [GPU](<../../GPU%20and%20NPU/GPU.md>) 能提供的资源时，就需要把这个计算分配到多个 devices。这里涉及到 [GPU Communication Topology](<../../GPU%20and%20NPU/GPU%20Communication%20Topology.md>)
