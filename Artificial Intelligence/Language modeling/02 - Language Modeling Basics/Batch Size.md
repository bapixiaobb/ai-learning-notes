...
如果使用 [gradient accumulation](<../03%20-%20Training%20and%20Scaling/Gradient%20Accumulation.md>)，则 effective batch size 可以写成：
...
>**Note**
>Batch size 既是 [training recipe](<../03%20-%20Training%20and%20Scaling/Training%20Recipe.md>) 的一部分，也和 [Systems for Language Models](<../01%20-%20System/Systems%20for%20Language%20Models.md>) 强相关。
>
...
在 [Scaling Law](<../03%20-%20Training%20and%20Scaling/Scaling%20Law.md>) 中会从 [Hyperparameter Choice](<../03%20-%20Training%20and%20Scaling/Hyperparameter%20Choice.md>) 了解到怎么选择 batch size，batch size 的选择有一个最优
