在显存放不下较大的 [batch](<../01%20-%20Language%20Modeling%20Basics/Batch%20Size.md>) 时，用多个 microbatches 累加梯度，再做一次 [optimizer step](<../../Transformer/05%20-%20Training/Optimizer.md>)。
