...
language model 做 forward pass，得到 [logits](<../01%20-%20Language%20Modeling%20Basics/Logits.md>)：

```math
z_1, z_2, \dots, z_T
```

然后用这些 logits 计算 [loss](<../../Neural%20Networks/Loss%20Function.md>)，例如 [Cross Entropy Loss](<../01%20-%20Language%20Modeling%20Basics/Cross%20Entropy%20Loss.md>)：
...
这里的 optimizer、learning rate、[batch size](<../01%20-%20Language%20Modeling%20Basics/Batch%20Size.md>)、weight decay 等不属于 [Model Architecture](<../05%20-%20Architectures%20and%20MoE/Model%20Architecture.md>)，而属于 [Training Recipe](<Training%20Recipe.md>)。
