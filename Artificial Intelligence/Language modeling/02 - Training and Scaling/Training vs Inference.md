...
>
>Training 和 inference 都会做 [Forward Pass in Transformer](<../../Transformer/Forward%20Pass%20in%20Transformer.md>)；区别在于 training 还会计算 loss、backward、optimizer step，而 inference 不更新参数。
...
>
两者都会做 [Forward Pass in Transformer](<../../Transformer/Forward%20Pass%20in%20Transformer.md>)。
>
