...
1. model output，例如 prediction 或 [logits](<../Language%20modeling/02%20-%20Language%20Modeling%20Basics/Logits.md>)；
...
[Recomputation](<../Language%20modeling/03%20-%20Training%20and%20Scaling/Recomputation.md>) 会少保存一些 activations，在 backward 时重新执行部分 forward，用 compute 换 memory。
...
## [Llama-style decoder](<../Transformer/00%20-%20Maps%20and%20Architectures/Llama-style%20Architecture.md>) forward graph
