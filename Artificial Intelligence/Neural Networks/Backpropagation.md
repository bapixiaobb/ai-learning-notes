...
为了进行 backward，PyTorch 通常需要保存 forward 中的一部分 [Activations](<Activations.md>)。[Recomputation](<../Language%20modeling/03%20-%20Training%20and%20Scaling/Recomputation.md>) 或 activation checkpointing 会选择少保存一些 activations，并在 backward 时重新计算，以交换 memory 和 compute。
