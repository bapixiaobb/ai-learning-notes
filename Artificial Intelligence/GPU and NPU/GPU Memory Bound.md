...
>如果一个算子在 [GPU](<GPU.md>) 上：搬很多 bytes，但只做很少 [FLOPs](<../Language%20modeling/01%20-%20System/FLOPs.md>)，那它就是 memory-bound。
...
3. 用 [Tiling](<../Language%20modeling/01%20-%20System/Tiling.md>) 把数据搬到快 memory
...
- Trick 1: [Low precision computation](<../Language%20modeling/03%20-%20Training%20and%20Scaling/Low%20precision%20computation.md>)
- Trick 2: [Operator fusion](<Operator%20fusion.md>)
- Trick 3: [Recomputation](<../Language%20modeling/03%20-%20Training%20and%20Scaling/Recomputation.md>)
...
- Trick 5 : [Tiling](<../Language%20modeling/01%20-%20System/Tiling.md>)
