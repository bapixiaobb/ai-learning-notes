...
In [training](Training vs Inference) process, after [[Forward Propagation]] (see [[TransformerLM.jpeg]]) we will get a loss function computed by [[Cross Entropy Loss]]. 
...
In training [[Transformer]] step size is called learning rate, we have [[Learning Rate Schedule]] 