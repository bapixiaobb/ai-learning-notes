...
它可以理解为每个 token position 当前拥有的 representation，而每个 [Transformer Block](<../00%20-%20Maps%20and%20Architectures/Transformer%20Block.md>) 都在这个主 representation 上添加新的更新量。
...
在 modern [Decoder-Only Transformer](<../00%20-%20Maps%20and%20Architectures/Decoder-Only%20Transformer.md>) 中，一个 [Transformer Block](<../00%20-%20Maps%20and%20Architectures/Transformer%20Block.md>) 通常有两次 residual update：
...
[Self-Attention](<../02%20-%20Attention/Self-Attention.md>) 读取当前 residual stream 中所有 token positions 的信息，计算 token mixing 的结果：
...
在 [Decoder-Only Transformer](<../00%20-%20Maps%20and%20Architectures/Decoder-Only%20Transformer.md>) 中，residual stream 有一个特别重要的约束：
...
1. token ids 经过 [Token Embedding](<../01%20-%20Inputs%20and%20Position/Token%20Embedding.md>) 得到初始 residual stream；
2. 每个 [Transformer Block](<../00%20-%20Maps%20and%20Architectures/Transformer%20Block.md>) 读取 residual stream；
