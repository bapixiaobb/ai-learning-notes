...
一个 Pre-Norm [Transformer Block](<../00%20-%20Maps%20and%20Architectures/Transformer%20Block.md>) 通常有两次 Pre-Norm update：
...
>**Important**
>[Original Transformer](<../00%20-%20Maps%20and%20Architectures/Original%20Transformer.md>) 使用的是 Post-Norm。
>
...
在 [Llama-style Architecture](<../00%20-%20Maps%20and%20Architectures/Llama-style%20Architecture.md>) 中，Pre-Norm 通常和 [RMSNorm](<RMSNorm.md>) 搭配。
