...
>**Note**
>这也是为什么 [Transformer Block](<../00%20-%20Maps%20and%20Architectures/Transformer%20Block.md>) 的输入和输出通常保持同样 shape。
>
...
[Original Transformer](<../00%20-%20Maps%20and%20Architectures/Original%20Transformer.md>) 使用 Post-Norm：
...
>
>这也是 modern [Decoder-Only Transformer](<../00%20-%20Maps%20and%20Architectures/Decoder-Only%20Transformer.md>) 常用 [Pre-Norm Transformer](<Pre-Norm%20Transformer.md>) 的原因之一。
