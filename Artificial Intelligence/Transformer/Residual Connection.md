...
在 [[Transformer Block]] 中，[[Self-Attention]] 和 [[MLP]] 通常都会通过 residual connection 写回主 hidden states。
...
>[!note]
>在 Transformer 中，residual connection 是 [[Residual Stream]] 形成的局部结构。
>
...
>
>这也是 modern [[Decoder-Only Transformer]] 常用 [[Pre-Norm Transformer]] 的原因之一。
...
>
>在 Transformer 中，attention 和 MLP 都通过 residual connection 把更新量写回主 hidden states。多个 residual connections 串联起来形成 [[Residual Stream]]。
>
