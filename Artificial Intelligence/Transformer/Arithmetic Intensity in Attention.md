...
和 [MLP 的 arithmetic intensity 计算](<./Arithmetic%20Intensity%20in%20MLP.md>) 相同，这里也只考虑 [Decoder-Only Transformer](<./Decoder-Only%20Transformer.md>) 中的 [self](<./Self-Attention.md>) [causal attention](<./Causal%20Attention.md>) 中的 Matmul 计算
