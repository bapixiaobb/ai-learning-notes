...
在 [Llama-style Architecture](<./Llama-style%20Architecture.md>) 中，常见 position encoding choice 是 [Rotary Position Embedding](<./Rotary%20Position%20Embedding.md>)。
...
Positional Encoding 告诉模型 token 的顺序位置；[Causal Mask](<./Causal%20Mask.md>) 限制模型不能看 future tokens。
