...
Rotary Position Embedding, 简称 RoPE, 是一种把 position information 注入 [Self-Attention](<../02%20-%20Attention/Self-Attention.md>) 的方法。它常见于 modern decoder-only LLM, 例如 [Llama-style Architecture](<../00%20-%20Maps%20and%20Architectures/Llama-style%20Architecture.md>)。
...
在 attention 中, 每个 token vector 会通过三个 linear projections 生成 [Query Key Value](<../02%20-%20Attention/Query%20Key%20Value.md>):
