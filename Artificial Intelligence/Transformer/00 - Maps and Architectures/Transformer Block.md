...
- $X^{(0)}$ 来自 [Token Embedding](<../01%20-%20Inputs%20and%20Position/Token%20Embedding.md>) 和 [Positional Encoding](<../01%20-%20Inputs%20and%20Position/Positional%20Encoding.md>)；
...
现代 decoder-only LLM 中常见的是 [Pre-Norm Transformer](<../04%20-%20Normalization%20and%20Residuals/Pre-Norm%20Transformer.md>) 结构。
...
>**Note**
>这里的两个加号就是 [Residual Connection](<../04%20-%20Normalization%20and%20Residuals/Residual%20Connection.md>)。
>
>它们让 attention 和 MLP 都作为对主 hidden state 的增量更新，而不是完全替换原来的 representation。

这条被不断更新的主 hidden state 路径通常可以理解成 [Residual Stream](<../04%20-%20Normalization%20and%20Residuals/Residual%20Stream.md>)。
...
具体的 $Q,K,V$、attention score 和 [Softmax](<../02%20-%20Attention/Softmax.md>) 机制放在 [Self-Attention](<../02%20-%20Attention/Self-Attention.md>) 和 [Multi-Head Attention](<../02%20-%20Attention/Multi-Head%20Attention.md>) 中整理。
...
>**Note**
>[Residual Stream](<../04%20-%20Normalization%20and%20Residuals/Residual%20Stream.md>) 可以理解为贯穿整个 Transformer 的主数据流。
>
>每个 block 不是从零生成新的 representation，而是在已有 representation 上添加更新量。

这和 [Residual Connection](<../04%20-%20Normalization%20and%20Residuals/Residual%20Connection.md>) 相关，但不是同一个概念：
[Residual Connection](<../04%20-%20Normalization%20and%20Residuals/Residual%20Connection.md>) 是具体的加法结构，[Residual Stream](<../04%20-%20Normalization%20and%20Residuals/Residual%20Stream.md>) 是这种加法结构贯穿多层后形成的主信息流。
...
>
>这也是 modern decoder-only LLM 常用 [Pre-Norm Transformer](<../04%20-%20Normalization%20and%20Residuals/Pre-Norm%20Transformer.md>) 的原因之一。
