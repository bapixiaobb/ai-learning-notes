...
它们共享 [Self-Attention](<../02%20-%20Attention/Self-Attention.md>)、[Transformer Block](<Transformer%20Block.md>)、[Residual Connection](<../04%20-%20Normalization%20and%20Residuals/Residual%20Connection.md>)、[Normalization](<../04%20-%20Normalization%20and%20Residuals/Normalization.md>) 等核心思想，但在整体结构、attention mask、输入输出形式和训练目标上不同。
...
>
>它们的核心训练目标通常是 Next Token Prediction，并通过 [Causal Mask](<../02%20-%20Attention/Causal%20Mask.md>) 保证模型不能看到 future tokens。
...
| attention variant | [Grouped-Query Attention](<../02%20-%20Attention/Grouped-Query%20Attention.md>) in many modern models |
...
>
>例如 [Decoder-Only Transformer](<Decoder-Only%20Transformer.md>) 和 [Next-token prediction](<../../Language%20modeling/02%20-%20Language%20Modeling%20Basics/Next-token%20prediction.md>) 非常匹配，因为 causal self-attention 刚好对应 autoregressive factorization。
